...
import HomeSidebarHeaderCreateGroup from './create-group';
...
const HomeSidebarHeader = () => {
  ...
  const handleOpenCreateGroupMenu = () => setShowCreateGroup(true);
  const handleCloseCreateGroupMenu = () => setShowCreateGroup(false);
        ...
        <div className="w-full flex items-center justify-between">
          ...
          <ul className="flex items-center gap-x-2.5">
            ...
            >
              ...
              {showMenu ? (
                <HomeSidebarHeaderMenu
                  token={user?.token}
                  handleCreateGroup={handleOpenCreateGroupMenu}
                />
              ) : null}
            </HomeMenuItem>
          </ul>
